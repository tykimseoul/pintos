...
static void page_fault(struct intr_frame *f)
{
    ...
    if (spte == NULL)
    {
        ...
        small_enough = PHYS_BASE - MAX_STACK_SIZE < fault_addr && fault_addr <= PHYS_BASE;
    ...
    //     {
    //         // printf("no spte\n");
    //         // printf("contiguous 1: %d\n", esp <= fault_addr );
    //         // printf("contiguous 2: %d\n",fault_addr == f->esp - 4);
    //         // printf("contiguous 3: %d\n",fault_addr == f->esp - 32);
    //         // printf("upage: %p\n", upage);
